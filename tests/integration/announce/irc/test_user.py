...
def test_account_created_announced(app):
    expected_text = 'Jemand hat das Benutzerkonto "JaneDoe" angelegt.'

    user = create_user('JaneDoe')
...
def test_account_created_by_admin_announced(app):
    expected_text = 'EinAdmin hat das Benutzerkonto "EinUser" angelegt.'

    admin = create_user('EinAdmin')
    user = create_user('EinUser')
...
def test_screen_name_change_announced(app):
    expected_text = 'ElAdmin hat das Benutzerkonto "DrJekyll" ' \
                    'in "MrHyde" umbenannt.'

    admin = create_user('ElAdmin')
    user = create_user('DrJekyll')
...
def test_suspended_account_announced(app):
    expected_text = 'She-Ra hat das Benutzerkonto "Skeletor" gesperrt.'

    admin = create_user('She-Ra')
    user = create_user('Skeletor')
...
def test_unsuspended_account_announced(app):
    expected_text = 'TheBoss hat das Benutzerkonto "RambaZamba" entsperrt.'

    admin = create_user('TheBoss')
    user = create_user('RambaZamba')
