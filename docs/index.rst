...
- The source code (including the documentation sources) is available
  free of charge `on GitHub <https://github.com/byceps/byceps>`_ and `on
...
- If you happen to find an issue or even a bug, please report it on the
  ...
  - If it could be a severe, security-critical issue, prefer to contact
    the project author directly.
