...
def create_document(party_id):
    ...
    signals.document_created.send(None, snippet_id=version.snippet.id)
...
def update_document(snippet_id):
    ...
    signals.document_updated.send(None, snippet_id=version.snippet.id)
...
def create_fragment(party_id):
    ...
    signals.fragment_created.send(None, snippet_id=version.snippet.id)
...
def update_fragment(snippet_id):
    ...
    signals.fragment_updated.send(None, snippet_id=version.snippet.id)
